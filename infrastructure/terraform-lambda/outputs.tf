output "api_gateway_url" {
  ...
  value       = module.lambda_http_service.api_endpoint
}

output "lambda_function_name" {
  description = "Name of the application Lambda function (used by the pipeline to wait for updates)."
  value       = module.lambda_http_service.function_name
}
