...
module "ecr_repository" {
  source = "github.com/jch254/terraform-modules//ecr-repository?ref=1.15.1"
...
module "ecs_http_service" {
  source = "github.com/jch254/terraform-modules//ecs-http-service?ref=1.15.1"
...
module "acm_certificate" {
  source = "github.com/jch254/terraform-modules//acm-dns-validated-certificate?ref=1.15.1"
...
module "api_gateway_custom_domain" {
  source = "github.com/jch254/terraform-modules//api-gateway-custom-domain?ref=1.15.1"
...
module "app_runtime_iam" {
  source = "github.com/jch254/terraform-modules//app-runtime-iam?ref=1.15.1"
...
module "codebuild_terraform_role" {
  source = "github.com/jch254/terraform-modules//codebuild-terraform-role?ref=1.15.1"
...
module "cookie_secret" {
  source = "github.com/jch254/terraform-modules//ssm-parameter-placeholder?ref=1.15.1"
